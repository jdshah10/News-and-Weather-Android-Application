...
public class BusinessHeadlinesFragment extends Fragment {
    ...
    String latestNewsUrl = "https://androidnewsappbackend.wl.r.appspot.com/headlinessectioncard?newsSection=business";


    public BusinessHeadlinesFragment() {
        // Required empty public constructor
    }

    public static BusinessHeadlinesFragment newInstance(String param1, String param2) {
        BusinessHeadlinesFragment fragment = new BusinessHeadlinesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       final View view = inflater.inflate(R.layout.fragment_business_headlines, container, false);
        // Inflate the layout for this fragment

        NewsList = new ArrayList<OurData>();

        recyclerView = (RecyclerView) view.findViewById(R.id.businesscardrecyclerview);
