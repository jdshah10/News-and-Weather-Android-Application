...
public class WorldHeadlinesFragment extends Fragment {
    ...
    String title, time, source, link, articleid, imagelink,lateTime,data, fulldate;

    String latestNewsUrl = "https://androidnewsappbackend.wl.r.appspot.com/headlinessectioncard?newsSection=world";
    public static WorldHeadlinesFragment newInstance(String param1, String param2) {
        WorldHeadlinesFragment fragment = new WorldHeadlinesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_world_headlines, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.worldcardrecyclerview);
                ...
                try{
                    ...
                    for (int i = 0 ; i < cardArray.length() ; i++){
                        if(cardArray.get(i)!="null"){
                            cardObj = (JSONObject) cardArray.get(i);
