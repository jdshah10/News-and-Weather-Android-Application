 ...
 * Use the {@link ScienceHeadlinesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ScienceHeadlinesFragment extends Fragment {
    ...
    String latestNewsUrl = "https://androidnewsappbackend.wl.r.appspot.com/headlinessectioncard?newsSection=science";

    public ScienceHeadlinesFragment() {
        // Required empty public constructor
    }

    public static ScienceHeadlinesFragment newInstance(String param1, String param2) {
        ScienceHeadlinesFragment fragment = new ScienceHeadlinesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_science_headlines, container, false);

        NewsList = new ArrayList<OurData>();

        recyclerView = (RecyclerView) view.findViewById(R.id.sciencecardrecyclerview);
