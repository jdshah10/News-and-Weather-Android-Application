...
public class SportsHeadlinesFragment extends Fragment {
    ...
    String latestNewsUrl = "https://androidnewsappbackend.wl.r.appspot.com/headlinessectioncard?newsSection=sport";
//    CardRecyclerAdapter.OnNoteListner onNoteListner;

    public SportsHeadlinesFragment() {
        // Required empty public constructor
    }

    public static SportsHeadlinesFragment newInstance(String param1, String param2) {
        SportsHeadlinesFragment fragment = new SportsHeadlinesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_sports_headlines, container, false);

        NewsList = new ArrayList<OurData>();

        recyclerView = (RecyclerView) view.findViewById(R.id.sportscardrecyclerview);
