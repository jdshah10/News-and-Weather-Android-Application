...
public class PoliticsHeadlinesFragment extends Fragment {
    ...
    String latestNewsUrl = "https://androidnewsappbackend.wl.r.appspot.com/headlinessectioncard?newsSection=politics";



    public PoliticsHeadlinesFragment() {
        // Required empty public constructor
    }

    public static PoliticsHeadlinesFragment newInstance(String param1, String param2) {
        PoliticsHeadlinesFragment fragment = new PoliticsHeadlinesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       final View view = inflater.inflate(R.layout.fragment_politics_headlines, container, false);

        NewsList = new ArrayList<OurData>();

        recyclerView = (RecyclerView) view.findViewById(R.id.politicscardrecyclerview);
